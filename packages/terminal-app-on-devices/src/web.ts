...
import type { ISdkManagedPaymentIntent } from '@stripe/terminal-app-on-devices-js';
import { loadStripeTerminal } from '@stripe/terminal-app-on-devices-js';
import type { DiscoverResult, ErrorResponse, Reader, Terminal } from '@stripe/terminal-app-on-devices-js/types/terminal-app-on-devices';
